...
3. **Home screen snapshot** — take a snapshot and confirm:
   - All topic world nodes are present (currently 9: Venn Village, Metric Mountain, Percent Peak, Money Market, Angle Academy, Chart City, Shape Station, Polygon Park, Fraction Forest)
